...
if(isset($_POST['submit']))
  {
    ...
    $eligiblity=$_POST['noofOpenings'];
    $jobloc=$_POST['jobloc'];
    $applydate=$_POST['applydate'];
    $lastdate=$_POST['lastdate'];
     
    $query=mysqli_query($con, "insert into  tblvacancy(CompanyID,JobTitle,MonthlySalary,JobDescriptions,NoofOpenings,JobLocation,ApplyDate,LastDate) value('$cid','$jtitle','$salary','$jobdecs','$eligiblity','$jobloc','$applydate','$lastdate')");
    if ($query) {
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body b-b">
                            ...
                            <div class="card-title">No Opening</div>
                            <div class="input-group">
                                <input type="text" class="form-control"
                                        name="noofOpenings" required="true"  placeholder="noofOpenings">
                            ...
                            <div class="input-group">
                                <input type="text" class="date-time-picker form-control"
                                       data-options='{"timepicker":false, "format":"d-m-Y"}' value="2022/01/01"/ id="applydate" name="applydate" required="true">
                            ...
                            <div class="input-group">
                                <input type="text" class="date-time-picker form-control"
                                       data-options='{"timepicker":false, "format":"d-m-Y"}' value="2022/01/01"/ id="lastdate" name="lastdate" required="true">
                                <span class="input-group-append">
                                    <span class="input-group-text add-on white">
                                        <i class="icon-calendar"></i>
                                    </span>
