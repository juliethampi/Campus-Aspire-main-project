...
<aside class="main-sidebar fixed offcanvas shadow">
 ...
 <h2 align="center"> CAMPUS ASPIRE</h2>
        </div>
        <div class="relative">
...
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="total-regcompany.php">
                <i class="icon icon icon-package blue-text s-18"></i> <span>Total Registered Company</span> 
            </a>
                
            </li>
            <li class="treeview"><a href="total-regusers.php">
                <i class="icon icon-account_box light-green-text s-18"></i> <span>Total Registered Users</span> 
            </a>
                
            </li>
            <li class="treeview"><a href="">
                <i class="icon icon-account_box light-green-text s-18"></i> <span>Placed Student Details</span> 
            </a>
